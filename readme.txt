...
**June 2017: Recently revived and completely rewritten.**

Use this plugin to delete some or all of Wordpress resized images (thumbnails, medium, large, and extra ones Plugins and Themes secretly made) from your uploads directory. This can clear thousands of unwanted files. Useful if you've had lots of different theme/plugins over the years, accumulating a vast number of resized images that are no longer used by your site.
